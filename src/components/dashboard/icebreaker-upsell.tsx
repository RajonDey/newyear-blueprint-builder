...
interface IcebreakerUpsellProps {
  planYear?: number
}

export function IcebreakerUpsell({ planYear }: IcebreakerUpsellProps) {
  const href = planYear ? `/plan/${planYear}#plan-goals` : "/plan/new"
