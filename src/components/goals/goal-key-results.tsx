...
interface GoalKeyResultsProps {
  goalId: string
  keyResults: KeyResult[]
}

export function GoalKeyResults({ goalId, keyResults }: GoalKeyResultsProps) {
        ...
        {keyResults.length === 0 && !showAdd && (
          <div className="text-center py-4">
            <p className="text-sm text-muted-foreground mb-3">
              Add measurable outcomes to track real progress toward this goal.
            </p>
            <Button
              variant="outline"
              size="sm"
