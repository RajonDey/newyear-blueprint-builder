        ...
        <Card className="p-6 md:p-8 lg:p-12 border-success/20 bg-gradient-to-br from-success/5 to-transparent">
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            <p className="text-foreground text-center">
              <strong>Here's the deal:</strong> Complete your free {APP_CONFIG.year} Blueprint. If you love it and want to unlock the full plan + Notion template + Guided eBook, it's just $9. Don't love it? Get a full refund within 30 days. No questions asked.
            </p>
          </div>
        </Card>
      </div>
