...
const categoryTheme: Record<
  string,
  { iconPath: string; color: string; lightColor: string }
> = {
  Health: {
    iconPath: "/assets/pdf-icons/icon-health.png",
    color: colors.health.main,
    lightColor: colors.health.light,
  },
  Wealth: {
    iconPath: "/assets/pdf-icons/icon-wealth.png",
    color: colors.wealth.main,
    lightColor: colors.wealth.light,
  },
  Relationships: {
    iconPath: "/assets/pdf-icons/icon-relationships.png",
    color: colors.relationships.main,
    lightColor: colors.relationships.light,
  },
  Career: {
    iconPath: "/assets/pdf-icons/icon-career.png",
    color: colors.career.main,
    lightColor: colors.career.light,
  },
  Learning: {
    iconPath: "/assets/pdf-icons/icon-learning.png",
    color: colors.learning.main,
    lightColor: colors.learning.light,
  },
  "Personal Growth": {
    iconPath: "/assets/pdf-icons/icon-growth.png",
    color: colors.personal.main,
    lightColor: colors.personal.light,
  },
  Social: {
    iconPath: "/assets/pdf-icons/icon-social.png",
    color: colors.social.main,
    lightColor: colors.social.light,
  },
  "Home/Environment": {
    iconPath: "/assets/pdf-icons/icon-home.png",
  ...
  return (
    <Page size="A4" style={styles.pageCover}>
      ...
      <View style={styles.coverContainer}>
        {/* Logo */}
        <Image src="/YearInReview-logo.png" style={styles.coverLogo} />
...
const ExecutiveSummary: React.FC<{ data: PDFData }> = ({ data }) => {
  const primaryTheme =
    categoryTheme[data.primaryCategory || ""] || categoryTheme["Career"];

  return (
    <Page size="A4" style={styles.page}>
      {/* Subtle logo watermark */}
      <Image src="/YearInReview-logo.png" style={styles.pageHeader} />
      ...
      <View style={styles.focusBox}>
        <View style={styles.focusRow}>
          <View style={styles.focusColumn}>
            ...
            >
              <Image
                src="/assets/pdf-icons/icon-star.png"
                style={{ width: 12, height: 12, marginRight: 6 }}
              />
              <Text style={styles.focusLabel}>PRIMARY FOCUS</Text>
            </View>
            <Text style={styles.focusText}>{data.primaryCategory}</Text>
          </View>
          <View style={styles.focusColumn}>
            <View
              style={{
            ...
            >
              <Image
                src="/assets/pdf-icons/icon-list.png"
                style={{ width: 12, height: 12, marginRight: 6 }}
              />
      ...
      <Text
        style={[
          styles.introText,
          { fontSize: 12, marginBottom: spacing["2xl"] },
        ]}
      >
        This blueprint outlines your strategic path for {APP_CONFIG.year}. You
        have identified {data.primaryCategory} as your "Keystone Habit" area—the
        one change that will create a ripple effect across your life. The
        following pages detail your specific goals, action steps, and motivation
        systems.
      </Text>
      ...
      >
        ...
        >
          "I am committed to taking consistent action on these goals. I
          understand that progress is better than perfection, and I will focus
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={[styles.goalCard, { backgroundColor: theme.lightColor }]}>
        ...
        <View style={styles.goalHeader}>
          <View style={[styles.goalBadge, { backgroundColor: theme.color }]}>
            <Image src={theme.iconPath} style={styles.goalBadgeIcon} />
      ...
      <View style={styles.timeline}>
        <View style={styles.timelineStep}>
          <View
            style={[styles.timelineDot, { backgroundColor: theme.color }]}
          />
          <Text style={styles.timelineLabel}>NOW</Text>
          <Text style={{ fontSize: 7, color: colors.slate[400] }}>
            Immediate
          </Text>
        </View>
        ...
        <View style={styles.timelineStep}>
          <View
            style={[styles.timelineDot, { backgroundColor: colors.slate[300] }]}
          />
      ...
      >
        <Image
          src="/assets/pdf-icons/icon-target.png"
...
export const generateSuccessPDF_React = async (data: PDFData) => {
  try {
    ...
    logger.error("React-PDF Generation Error:", error);
